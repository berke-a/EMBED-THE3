...
# 7 "../../Desktop/336/the3/Includes.h" 2
...
# 12 "../../Desktop/336/the3/the3.c" 2
# 1 "/opt/microchip/xc8/v2.30/pic/include/c99/math.h" 1 3
# 15 "/opt/microchip/xc8/v2.30/pic/include/c99/math.h" 3
# 1 "/opt/microchip/xc8/v2.30/pic/include/c99/bits/alltypes.h" 1 3
...
void seven_segment(){
 ...
 _delay((unsigned long)((1)*(40000000/4000.0)));
    LATJ=0x00;
 LATH = 0x08;
 LATJ = SSEGMENT_NUMBERS_GLYPHS[(int) log2f(row)];
 _delay((unsigned long)((1)*(40000000/4000.0)));
    LATJ=0x00;
}
...
void Pulse(void){
    PORTBbits.RB5 = 1;
    _delay((unsigned long)((30)*(40000000/4000000.0)));
    PORTBbits.RB5 = 0;
    _delay((unsigned long)((30)*(40000000/4000000.0)));
}
...
void InitLCD(void) {
    ...
    _delay((unsigned long)((6)*(40000000/4000.0)));
    PORTD = 0x30;
    Pulse();

    _delay((unsigned long)((300)*(40000000/4000000.0)));
    PORTD = 0x30;
    Pulse();
